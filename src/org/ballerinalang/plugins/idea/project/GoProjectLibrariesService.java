...
@State(
        ...
        storages = {
                ...
                @Storage(id = "dir", file = StoragePathMacros.PROJECT_CONFIG_DIR + "/" +
                        BallerinaConstants.GO_LIBRARIES_CONFIG_FILE, scheme = StorageScheme.DIRECTORY_BASED)
        }
)
public class GoProjectLibrariesService extends BallerinaLibraryService<BallerinaLibraryState> {
