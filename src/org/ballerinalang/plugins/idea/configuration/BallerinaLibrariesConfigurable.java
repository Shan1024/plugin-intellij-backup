...
public class BallerinaLibrariesConfigurable implements SearchableConfigurable, Configurable.NoScroll {
    ...
    private final BallerinaLibraryService<?> myLibrariesService;
    private final String[] myReadOnlyPaths;
    private final JBCheckBox myUseEnvGoPathCheckBox = new JBCheckBox("Use BALLERINA_REPOSITORY that's defined in " +
            "system environment");
    private final JPanel myPanel = new JPanel(new BorderLayout());
    private final CollectionListModel<ListItem> myListModel = new CollectionListModel<>();

    public BallerinaLibrariesConfigurable(@NotNull String displayName, @NotNull BallerinaLibraryService
    ...
    private void resetLibrariesFromEnvironment() {
        if (myLibrariesService instanceof GoApplicationLibrariesService) {
            myUseEnvGoPathCheckBox.setSelected(((GoApplicationLibrariesService) myLibrariesService)
